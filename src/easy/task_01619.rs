...
mod tests {
    ...
    fn test_1() {
        ...
        let diff = (2.0 - Solution::trim_mean(arr)).abs();
        assert!(diff < EPSILON);
    }
    ...
    fn test_2() {
        ...
        let diff = (4.0 - Solution::trim_mean(arr)).abs();
        assert!(diff < EPSILON);
    }
    ...
    fn test_3() {
        ...
        let diff = (5.277777777777778 - Solution::trim_mean(arr)).abs();
        assert!(diff < EPSILON);
    }
    ...
    fn test_4() {
        ...
        let diff = (5.291666666666667 - Solution::trim_mean(arr)).abs();
        assert!(diff < EPSILON);
    }
}